export const LANG_SHARDED_ARTICLE_TABLES = new Set(['en', 'de', 'fr', 'es', 'pt', 'ar', 'hi']);

/**
 * Return the physical articles table name for a given language.
 * If the language is one of the sharded tables (en, de, fr, es, pt, ar, hi) we
 * route to `articles_<lang>`; otherwise we fall back to the legacy `articles`
 * table which still stores any yet-to-be-migrated languages.
 *
