...
const awarenessTemplates = [
  {
    ...
    user: `Write an educational article explaining ONE specific environmental issue and its impact. Make it engaging and actionable.${COMMON_STRUCTURE}`,
  },
  {
    system: `You are a climate science communicator who translates research into practical understanding.`,
    user: `Create an article explaining ONE aspect of climate change in simple terms. Include current examples and data.${COMMON_STRUCTURE}`,
  },
  {
    system: `You are an environmental journalist who investigates pressing ecological issues.`,
    user: `Write an investigative piece on ONE current environmental challenge. Focus on facts and solutions.${COMMON_STRUCTURE}`,
  },
];
...
const sustainableLivingTemplates = [
  {
    ...
    user: `Write a practical guide for ONE specific area of sustainable living. Include step-by-step instructions and cost comparisons.${COMMON_STRUCTURE}`,
  },
  {
    system: `You are a zero-waste lifestyle expert who believes in gradual, achievable changes.`,
    user: `Create a beginner-friendly guide to reducing waste in ONE specific area. Focus on realistic, budget-friendly options.${COMMON_STRUCTURE}`,
  },
  {
    system: `You are an eco-conscious consumer advocate who helps people make informed purchasing decisions.`,
    user: `Write a guide to making sustainable choices in ONE specific product category. Include specific brand recommendations and certifications to look for.${COMMON_STRUCTURE}`,
  },
];
...
const greenTechTemplates = [
  {
    ...
    user: `Write an article about ONE emerging green technology and its potential impact. Explain the technology simply and discuss real-world applications.${COMMON_STRUCTURE}`,
  },
  {
    system: `You are a renewable energy expert who explains complex systems in simple terms.`,
    user: `Create an educational article about ONE type of renewable energy. Include current costs, efficiency, and future prospects.${COMMON_STRUCTURE}`,
  },
  {
    system: `You are a sustainable innovation researcher who identifies game-changing environmental solutions.`,
    user: `Write about ONE innovative solution to an environmental problem. Discuss both the potential and current limitations.${COMMON_STRUCTURE}`,
  },
];
...
const conservationTemplates = [
  {
    ...
    user: `Write an article about ONE specific conservation effort or endangered species. Include what individuals can do to help.${COMMON_STRUCTURE}`,
  },
  {
    system: `You are an ecosystem expert who explains the interconnectedness of nature.`,
    user: `Create an article explaining the importance of ONE specific ecosystem and the threats it faces. Make the connections clear and compelling.${COMMON_STRUCTURE}`,
  },
  {
    system: `You are a marine biologist who advocates for ocean protection.`,
    user: `Write about ONE aspect of ocean conservation. Include actionable steps for readers.${COMMON_STRUCTURE}`,
  },
];
